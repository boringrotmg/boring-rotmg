package com.company.assembleegameclient.ui.tooltip.slotcomparisons
{
   ...
   public class GeneralProjectileComparison extends SlotComparison
   {
      ...
      private function buildRateOfFireText() : void
      {
         ...
         var curRateOfFire:Number = Number(this.curItemXML.RateOfFire[0]);
         var rateOfFire:Number = Number(this.itemXML.RateOfFire[0]);
         var percent:int = int(rateOfFire / curRateOfFire * 100);
         var deltaPercent:int = percent - 100;
         if(deltaPercent == 0)
         {
            return;
         }
         var color:String = getTextColor(deltaPercent);
         var str:String = deltaPercent.toString();
         if(deltaPercent > 0)
         {
            str = "+" + str;
         }
         str = wrapInColoredFont(str + "%",color);
         comparisonText = comparisonText + ("Rate of Fire: " + str + "\n");
