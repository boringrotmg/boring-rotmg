...
import com.company.util.AssetLibrary;
   ...
   public class IconFactory
   {
      ...
      {
         var data:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3",225),null,size,true,0,0);
         return cropAndGlowIcon(data);
      }
      
      public static function makeFame(size:int = 40) : BitmapData
      {
         var data:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3",224),null,size,true,0,0);
         return cropAndGlowIcon(data);
      }
